...
Converts WordPress TwentySeventeen theme into Progressive Web Apps and Accelerated Mobile Pages style.

== Description ==

PWA AMP plugin converts WordPress TwentySeventeen theme into Progressive Web Apps and Accelerated Mobile Pages style.  It depends on PWA AMP plugin, install and activate PWA AMP plugin before activate this one.  For more theme conversion, please visit: https://flexplat.com/pwamp-wordpress/ .

== Installation ==
1. Upload the plugin files to the '/wp-content/plugins/pwamp-twentyseventeen' directory.
...
== Download ==
1. GitHub: https://github.com/rickey29/pwamp-wordpress-twentyseventeen

== Demo sites ==
1. https://twentyseventeen.flexplat.com/?amp=1
2. https://twentyseventeen-2.flexplat.com/?amp=1
